...
<body>
				...
				<div class="highlight-1">
					<form action="" method="post" enctype="multipart/form-data">
                        <div class="form-content a">
                            ...
                            <input type="text" name="txtuser" id="username" placeholder="Enter your user name" onkeyup="validateUser()">
                            <span class="error-user"></span>
                        </div>
                        <div class="form-content">
                            <label for="password">Password</label> <br>
                            <input type="password" name="txtpassword" id="password" placeholder="Enter your password" onkeyup="validateUser()">
    ...
    if(isset($_POST['sbm'])){
        ...
        echo"<script>alert('User name , password và repassword không được để trống');</script>";
            ...
            $insert=$get_date->in_user($_POST['txtuser'],$_POST['txtpassword'],$_POST['txtdate'],$_POST['txtgender'],$_POST['txtaddress'],$_FILES['txtfile']['name']
            ,$quyen);
            if($insert){
